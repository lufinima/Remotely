...
try {
    ...
    Invoke-WebRequest -Uri "https://github.com/lufinima/Remotely/releases/latest/download/Remotely_Server_Win-x64.zip" -OutFile "$env:TEMP\Remotely_Server_Win-x64.zip"
