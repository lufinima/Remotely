...
if ($Hostname) {
    ...
    #Replace-LineInFile -FilePath "$Root\Desktop.XPlat\Properties\PublishProfiles\packaged-linux-x64.pubxml" -MatchPattern "<PublishDir>" -ReplaceLineWith "    <PublishDir>..\Agent\bin\Release\net6.0\linux-x64\publish</PublishDir>"
